...
import (
	...
	"github.com/stakater/IngressMonitorController/v2/pkg/monitors/uptimekumaapi"
...
func (mp *MonitorServiceProxy) OfType(mType string) MonitorServiceProxy {
	...
	case "UptimeKumaApi":
		mp.monitor = &uptimekumaapi.UptimeKumaApiMonitorService{}
	default:
...
func (mp *MonitorServiceProxy) ExtractConfig(spec endpointmonitorv1alpha1.EndpointMonitorSpec) interface{} {
	...
	case "UptimeKumaApi":
		config = spec.UptimeKumaApiConfig
	default:
		return config
	}
	return config
